	...
	<?php
		...
		if(!empty($_POST['Nom']) && !empty($_POST['Description']) && !empty($_POST['Prix'])){
			...
			if($photo1==1 && $photo2==0 && $photo3==0 && $video==0){
				...
				$req2->execute(array($_POST['Nom'],$nom_img1,$extension1,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
			if($photo1==1 && $photo2==1 && $photo3==0 && $video==0){
				...
				$req2->execute(array($_POST['Nom'],$nom_img1,$extension1,$nom_img2,$extension2,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
			if($photo1==1 && $photo2==1 && $photo3==1 && $video==0){
				...
				$req2->execute(array($_POST['Nom'],$nom_img1,$extension1,$nom_img2,$extension2,$nom_img3,$extension3,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
			if($photo1==1 && $photo2==0 && $photo3==0 && $video==1){
				...
				$req2->execute(array($_POST['Nom'],$nom_img1,$extension1,$nom_vid,$extensionv,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
			if($photo1==1 && $photo2==1 && $photo3==0 && $video==1){
				...
				$req2->execute(array($_POST['Nom'],$nom_img1,$extension1,$nom_img2,$extension2,$nom_vid,$extensionv,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
			if($photo1==1 && $photo2==1 && $photo3==1 && $video==1){
				...
				$req2->execute(array($_POST['Nom'],$nom_img1,$extension1,$nom_img2,$extension2,$nom_img3,$extension3,$nom_vid,$extensionv,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
			if($photo1==0 && $photo2==0 && $photo3==0 && $video==1){
				...
				$req2->execute(array($_POST['Nom'],$nom_vid,$extensionv,$_POST['Description'],$_POST['Prix'],$_POST['catégorie'],$_POST['catégorie'],"1"));
				//REMPLACER 1 PAR $_SESSION['ID']
				$req2->closeCursor();
			}
