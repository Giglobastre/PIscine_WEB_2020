...
<body>
  ...
  <div class="topnav">
    <div style="float:left">
      ...
      <a href="BARREDERECHERCHE.php">BDR</a>
  ...
  <marquee align="center" height="250" scrolldelay="15" scrollamount="15" onmouseout="this.start()" onmouseover="this.stop()"> 
    ...
    if(isset($_GET['q']) AND !empty($_GET['q'])) {
        ...
        if($objets->rowcount()==0){
            $objets = $bdd->query('SELECT Nom FROM objets WHERE CONCAT(Nom, Description, Catégorie) LIKE "%'.$q.'%" ORDER BY ID DESC');      
        }
    }
    ?>
    ...
    <?php if($objets->rowCount() > 0){ ?>
    <br/>
    <h3><b>Résultat de votre recherche</b></h3>
        <br/>
        <?php while ($data = $objets->fetch()){
        echo '<div id="objet">
                <center>
                  <h3><b>'.$data['Nom'].'</b></h3>
