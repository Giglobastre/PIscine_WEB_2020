...
<body>
  ...
  <br /> 
        <div style="padding-left:30px">
            ...
            <h3>Objets appartenant à la catégorie Ferraille ou trésors</h3>
        </div>
        ...
        $req = $bdd->prepare('SELECT ID,Nom, Photo1_nom, Photo1_extension, Prix, Description, Catégorie FROM objets WHERE Catégorie=1 ORDER BY ID DESC'); //ajouter LIMIT poour en prendre qu'un certain nombre & order bypour que ce soit les dernieres
        $req->execute();
